  ...
  return (
    ...
    <div className="migration-container">
      <section className="migration-hero">
        ...
        <p className="breadcrumb">
          <span>🏠 Home</span> &gt; <span>Migration Services</span> &gt; <span>Lift & Shift</span>
        </p>
        <Link to="/contact-us" className="consultation-btn">Schedule Migration Assessment</Link>          
      </section>

      <section className="migration-content">
        <h2 className="section-title">Seamless Cloud Transition</h2>
        
        <div className="split-screen">
          <div className="text-side">
            <div className="migration-description">
              <p>
                Migrate legacy workloads with <strong>zero data loss</strong> and minimal downtime using our lift-and-shift services. We handle the complete migration lifecycle from planning to post-migration optimization.
              </p>
              <p>
                Our team specializes in <strong>architecture replication</strong>, infrastructure mapping, and rigorous testing to ensure business continuity during your cloud transition. We maintain your existing application architecture while moving it to the cloud.
              </p>
              <p>
                With proven methodologies and automated tools, we accelerate your migration timeline while reducing risk. Our phased approach ensures each workload is properly validated before cutting over to production.
              </p>
            </div>
          </div>

          <div className="image-side">
            <img src={migrationImage} alt="Migration Process Flow" className="migration-image" />
          </div>
        </div>

        <div className="migration-benefits">
          <h3 className="benefits-title">Migration <span>Advantages</span></h3>
          <div className="benefit-list">
            <div className="benefit-item">
              <div className="benefit-icon">🚀</div>
              <div>
                <strong>Rapid Transition:</strong> Move workloads quickly with minimal code changes
              </div>
            </div>
            <div className="benefit-item">
              <div className="benefit-icon">⏱️</div>
              <div>
                <strong>Reduced Downtime:</strong> Carefully planned cutover windows
              </div>
            </div>
            <div className="benefit-item">
              <div className="benefit-icon">🛡️</div>
              <div>
                <strong>Risk Mitigation:</strong> Comprehensive testing and rollback plans
              </div>
            </div>
          </div>
        </div>
