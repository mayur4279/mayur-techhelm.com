import '../../css/SecurityEnhancement.css';
  ...
  return (
    ...
    <div className="hybrid-cloud-container">
      ...
      <section className="security-hero">
        <h1>Advanced Security Enhancement</h1>
        <p className="breadcrumb">
          <span>🏠 Home</span> &gt; <span>Security Services</span> &gt; <span>Security Enhancement</span>
        </p>
        <Link to="/contact-us" className="consultation-btn">Request Security Review</Link>          
      </section>

      <section className="security-content">
        <h2 className="section-title">Proactive Threat Protection</h2>
        
        <div className="split-screen">
          <div className="text-side">
            <div className="security-description">
              <p>
                Security is our core priority. With <strong>Microsoft Defender for Cloud</strong> and <strong>Sentinel</strong>, we proactively identify risks, monitor compliance, and respond to threats in real time across your hybrid environment.
              </p>
              <p>
                Our security experts integrate these advanced tools to elevate visibility, automate defenses, and harden your infrastructure against evolving attacks. We implement continuous monitoring with AI-driven threat detection and automated response playbooks.
              </p>
              <p>
                From vulnerability assessments to incident response, we provide end-to-end security enhancement services that align with industry frameworks like NIST and CIS benchmarks.
              </p>
            </div>
          </div>

          <div className="image-side">
            <img src={securityImage} alt="Security Enhancement Dashboard" className="security-image" />
          </div>
        </div>

        <div className="security-features">
          <h3 className="features-title">Security <span>Capabilities</span></h3>
          <div className="feature-list">
            <div className="feature-item">
              <div className="feature-icon">🔍</div>
              <div>
                <strong>Threat Detection:</strong> AI-powered anomaly and breach detection
              </div>
            </div>
            <div className="feature-item">
              <div className="feature-icon">🛡️</div>
              <div>
                <strong>Automated Defense:</strong> Real-time response to security incidents
              </div>
            </div>
            <div className="feature-item">
              <div className="feature-icon">📊</div>
              <div>
                <strong>Compliance Monitoring:</strong> Continuous security posture assessment
              </div>
            </div>
          </div>
        </div>
