...
import CostOptimization from '../../assets/cost-optimization.jpg';
      ...
      <section className="monitoring-content">
        ...
        <div className="split-screen">
          ...
          <div className="image-side">
            <img src={CostOptimization} alt="Monitoring Dashboard" className="monitoring-image" />
          </div>
        </div>
    ...
    <div className="cost-container">
      ...
      <section className="cost-content">
        ...
        <div className="split-screen">
          ...
          <div className="image-side">
            <img src={costImage} alt="Cost Optimization Dashboard" className="cost-image" />
          </div>
        </div>
